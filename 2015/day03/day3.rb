...
result = data.each_char.with_object(Set.new) do |char, set|
  set << current_position

  direction = map[char]
  current_position = current_position.zip(direction).map { |a, b| a + b }
end
...
data.each_char.with_index do |char, index|
  current_position = index.odd? ? santa_position : robot_position
